...
namespace Interface_IClone
{
    ...
    class Tank : ICloneable
    {
        ...
        private Tank(int mass, int engine, int max_speed, int power_reserve, int fuel_t, int armor, int consumption)
        {
            this.mass = mass;
            this.engine = engine;
        ...
        private int mass, engine, max_speed, power_reserve, fuel_t, armor, consumption;
    }
